// MiddlewareImprocessDll.cpp : 定义 DLL 的初始化例程。
//
...
//// 为了兼容自主软件的版本
//#ifdef _DEBUG
//#pragma comment(lib,"../Debug/LogTxt.lib")
//#else
//#pragma comment(lib,"../Release/LogTxt.lib")
//#endif // _DEBUG
...
// 唯一的一个 CMiddlewareImprocessDllApp 对象

CMiddlewareImprocessDllApp theApp;


// CMiddlewareImprocessDllApp 初始化
