...
void ParaInter::write(cv::FileStorage& fs) const //Write serialization for this class
{
	...
	fs << "maskCorner_left_width" << pre_para.maskCorner_left_width;
	fs << "maskCorner_left_height" << pre_para.maskCorner_left_height;
	fs << "bg_ie" << pre_para.bg.ie;
	fs << "bg_is" << pre_para.bg.is;
	fs << "bg_minvar_e" << pre_para.bg.minvar_e;
	fs << "bg_minvar_s" << pre_para.bg.minvar_s;
	fs << "bg_occurBg" << pre_para.bg.occurBg;
	fs << "bg_sensity" << pre_para.bg.sensity;
	fs << "bg_var0_e" << pre_para.bg.var0_e;
	fs << "bg_var0_s" << pre_para.bg.var0_s;
	fs << "bg_varthres_e" << pre_para.bg.varthres_e;
	fs << "bg_varthres_s" << pre_para.bg.varthres_s;
	fs << "var_weight" << pre_para.var_weight;
	fs << "maskCorner_right_width" << pre_para.maskCorner_right_width;
	fs << "maskCorner_right_height" << pre_para.maskCorner_right_height;

	fs << "maskCorner_left_x" << pre_para.maskCorner_left_x;
	fs << "maskCorner_left_y" << pre_para.maskCorner_left_y;
	fs << "maskCorner_right_x" << pre_para.maskCorner_right_x;
	fs << "maskCorner_right_y" << pre_para.maskCorner_right_y;
...
void ParaInter::read(const cv::FileNode& node)  //Read serialization for this class
{
	...
	pre_para.maskCorner_left_width = n["maskCorner_left_width"];
	pre_para.maskCorner_left_height = n["maskCorner_left_height"];
	pre_para.maskCorner_right_width = n["maskCorner_right_width"];
	pre_para.maskCorner_right_height = n["maskCorner_right_height"];

	 pre_para.bg.ie = n["bg_ie"];
	 pre_para.bg.is = n["bg_is"];
	 pre_para.bg.minvar_e = n["bg_minvar_e"];
	 pre_para.bg.minvar_s = n["bg_minvar_s"];
	 pre_para.bg.occurBg = n["bg_occurBg"];
	 pre_para.bg.sensity = n["bg_sensity"];
	 pre_para.bg.var0_e = n["bg_var0_e"];
	 pre_para.bg.var0_s = n["bg_var0_s"];
	 pre_para.bg.varthres_e = n["bg_varthres_e"];
	 pre_para.bg.varthres_s = n["bg_varthres_s"];
	 pre_para.var_weight = n["var_weight"];

	pre_para.maskCorner_left_x = n["maskCorner_left_x"];
	pre_para.maskCorner_left_y = n["maskCorner_left_y"];
	pre_para.maskCorner_right_x = n["maskCorner_right_x"];
	pre_para.maskCorner_right_y = n["maskCorner_right_y"];
