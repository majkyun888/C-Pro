...
void CDParaInter::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_E_maskCorner_left_width, pre_para.maskCorner_left_width);
	DDX_Text(pDX, IDC_E_maskCorner_left_height, pre_para.maskCorner_left_height);
	DDX_Text(pDX, IDC_E_maskCorner_right_width, pre_para.maskCorner_right_width);
	DDX_Text(pDX, IDC_E_maskCorner_right_height, pre_para.maskCorner_right_height);

	DDX_Text(pDX, IDC_E_bg_ie, pre_para.bg.ie);
	DDX_Text(pDX, IDC_E_bg_is, pre_para.bg.is);
	DDX_Text(pDX, IDC_E_bg_minvar_e, pre_para.bg.minvar_e);
	DDX_Text(pDX, IDC_E_bg_minvar_s, pre_para.bg.minvar_s);
	DDX_Text(pDX, IDC_E_bg_occurBg, pre_para.bg.occurBg);
	DDX_Text(pDX, IDC_E_bg_sensity, pre_para.bg.sensity);
	DDX_Text(pDX, IDC_E_bg_var0_e, pre_para.bg.var0_e);
	DDX_Text(pDX, IDC_E_bg_var0_s, pre_para.bg.var0_s);
	DDX_Text(pDX, IDC_E_bg_varthres_e, pre_para.bg.varthres_e);
	DDX_Text(pDX, IDC_E_bg_varthres_s, pre_para.bg.varthres_s);
	DDX_Text(pDX, IDC_E_bg_var_weight, pre_para.var_weight);
	

	DDX_Text(pDX, IDC_E_maskCorner_left_x, pre_para.maskCorner_left_x);
	DDX_Text(pDX, IDC_E_maskCorner_left_y, pre_para.maskCorner_left_y);
	DDX_Text(pDX, IDC_E_maskCorner_right_x, pre_para.maskCorner_right_x);
	DDX_Text(pDX, IDC_E_maskCorner_right_y, pre_para.maskCorner_right_y);

	DDX_Text(pDX, IDC_E_RGL, pre_para.rgl);
}
