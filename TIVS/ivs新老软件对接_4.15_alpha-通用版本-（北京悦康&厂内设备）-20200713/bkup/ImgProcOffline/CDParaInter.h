...
public:
	CDParaInter(algoParticleDi::ParticleType& _particle_type, algoParticleDi::PrePara& _pre_para, algoParticleDi::IsProcRegPD& _is_proc_regPD, CWnd* pParent = nullptr);   // 标准构造函数
	virtual ~CDParaInter();
...
public:
	...
	afx_msg void OnSelchangeCmbDefaultPattern();
};
