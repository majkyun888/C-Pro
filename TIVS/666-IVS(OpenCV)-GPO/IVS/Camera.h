...
#define BIT_COSMETIC2    (1<<25)  //  33554432 - Cosmetic2 / SideWall / Stopper / Needle shield
#define BIT_COSMETIC3    (1<<26)  //  67108864 - Cosmetic3 / SideWall / Stopper / Needle shield
#define BIT_COSMETIC4    (1<<27)  // 134217728 - Cosmetic4 / SideWall / Stopper / Needle shield

// add for neck inspect
//#define BIT_NECK1     (1<<25)  // neck1
//#define BIT_NECK2     (1<<26)  // neck1
//#define BIT_NECK3     (1<<27)  // neck1
// add end
